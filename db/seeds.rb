...
User.create(
    user_name: "senor_cheng",
    name: "Michael Cheng",
    age: 31,
    bio: "Through the power of positive thinking, I grew this totally real beard!",
    instagram: "senor_cheng",
    twitter: "senor_cheng",
    profile_picture: "https://i.imgur.com/DDEnlLs.png",
    password: "password123"
)
